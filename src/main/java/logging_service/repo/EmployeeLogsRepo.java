...
public interface EmployeeLogsRepo extends JpaRepository<EmployeeLogs, Long> {
    List<EmployeeLogs> findByDateCreatedBetween(OffsetTime startDate, OffsetTime endDate, Pageable pageable);
    List<EmployeeLogs> findByUserIdAndDateCreatedBetween(Long userId, OffsetTime startDate, OffsetTime endDate, Pageable pageable);
